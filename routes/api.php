    ...
    function () {
        ...
        Route::group(['middleware' => ['auth:api']], function () {
            ...
            Route::group(['prefix' => 'division'], function () {
                Route::get('/all','DivisionController@all');
                Route::get('/get-all','DivisionController@get_all');
            ...
            Route::group(['prefix' => 'district'], function () {
                Route::get('/all','DistrictController@all');
                Route::get('/district-by-division/{id}','DistrictController@district_by_division');
                Route::get('/get-all','DistrictController@get_all');
                Route::post('/store','DistrictController@store');
                Route::post('/update','DistrictController@update');
                Route::post('/destroy','DistrictController@destroy');
                Route::get('/{id}','DistrictController@show');
            });

            // Upozila apis
            Route::group(['prefix' => 'upozila'], function () {
                Route::get('/all','UpozilaController@all');
                Route::get('/get-all','UpozilaController@get_all');
                Route::get('/upozila-by-district/{id}','UpozilaController@upozila_by_district');
                Route::post('/store','UpozilaController@store');
                Route::post('/update','UpozilaController@update');
                Route::post('/destroy','UpozilaController@destroy');
                Route::get('/{id}','UpozilaController@show');
            });
            ...
            Route::group(['prefix' => 'contact-message'], function () {
                ...
                Route::post('/update-status','Admin\ContactMessageController@update_status');
            ...
            Route::group(['prefix' => 'branch'], function () {
                ...
                Route::get('/get-all-institute-branches','Management\BranchController@get_institute_branches');
            ...
            Route::group(['prefix' => 'branch-contact'], function () {
                Route::get('/all','Management\BranchContactController@all');
                Route::post('/store','Management\BranchContactController@store');
                Route::post('/update','Management\BranchContactController@update');
                Route::post('/destroy','Management\BranchContactController@destroy');
                Route::get('/{id}','Management\BranchContactController@show');
            });

            // admin sections
            Route::get('/dashboard_stats','Admin\DashboardController@get_dashboard_stats');
            Route::post('/dashboard_stats_by_month','Admin\DashboardController@get_dashboard_stats_by_month');
            Route::get('/branch_dashboard_stats','Admin\DashboardController@get_dashboard_stats');
            Route::post('/branch_dashboard_stats_by_month','Admin\DashboardController@branch_dashboard_stats_by_month');
            ...
            Route::group(['prefix' => 'account/admin-accounts'], function () {
                ...
                Route::get('/all-json','Management\Branch\AccountsController@admin_accounts_json');
            });
            ...
            Route::group(['prefix' => 'institute/admin-batch'], function () {
                ...
                Route::get('/get-all','Management\Institute\InstituteClassBatchController@get_all');
            ...
            Route::group(['prefix' => 'admin-employee'], function () {
                ...
                Route::post('/admin-store','Management\Institute\EmployeeController@admin_store');
            ...
            Route::group(['prefix' => 'institute/admin-student'], function () {
                ...
                Route::post('/store','Management\Institute\InstituteStudentController@admin_store');
                Route::post('/update','Management\Institute\InstituteStudentController@admin_update');
                Route::post('/soft-delete','Management\Institute\InstituteStudentController@admin_soft_delete');
                Route::post('/restore','Management\Institute\InstituteStudentController@admin_restore');
                Route::post('/destroy','Management\Institute\InstituteStudentController@admin_destroy');
            ...
            Route::group(['prefix' => 'admin_attendence_employee'], function () {
                ...
                Route::get('/admin-all','Management\Institute\EmployeeAttendenceController@admin_all');
            ...
            Route::group(['prefix' => 'account/expense'], function () {
                ...
                Route::get('/fetch-expense-by-month/{month}','Management\Branch\ExpenseController@monthlyExpenseSheet');
            ...
            Route::group(['prefix' => 'account/income'], function () {
                ...
                Route::get('fetch-income-by-month/{month}', 'Management\Branch\IncomeController@monthlyIncomeSheet');
            ...
            Route::group(['prefix' => 'account/monthly_fee'], function () {
                ...
                Route::get('/all-dues','Management\Branch\MonthlyfeeController@fetch_due_monthly');
            ...
            Route::group(['prefix' => 'salary-statement'], function () {
                ...
                Route::get('salary-categories', 'Management\SalaryStatementController@salary_categories');
            ...
            Route::group(['prefix' => 'institute/teacher'], function () {
                Route::get('/branch-all-teachers','Management\Institute\InstituteTeacherController@branch_all_teachers');
                Route::get('/all','Management\Institute\InstituteTeacherController@all');
                Route::get('/all-teachers','Management\Institute\InstituteTeacherController@all_teachers');
            ...
            Route::group(['prefix' => 'institute/class'], function () {
                ...
                Route::post('/bulk-import','Management\Institute\InstituteClassController@bulk_import');
            ...
            Route::group(['prefix' => 'institute/class_batch'], function () {
                Route::get('/all-json','Management\Institute\InstituteClassBatchController@all_json');
                ...
                Route::get('/subjects','Management\Institute\InstituteClassBatchController@batch_related_subjects');
            ...
            Route::group(['prefix' => 'student/payments'], function () {
                ...
                Route::post('/dues','Management\Payment\StudentPaymentController@user_dues');
