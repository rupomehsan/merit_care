...
class AccountLogSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $account_log->date = Carbon::now()->subMonth(1)->toDateString();
        $account_log->save();
        ...
        $account_log->is_income = 0;
        $account_log->is_expense = 1;
        $account_log->date = Carbon::now()->subMonth(2)->toDateString();
        $account_log->save();
        ...
        $account_log->is_income = 0;
        $account_log->is_expense = 1;
        $account_log->date = Carbon::now()->subMonth(3)->toDateString();
        $account_log->save();
        ...
        $account_log->is_income = 0;
        $account_log->is_expense = 1;
        $account_log->date = Carbon::now()->subMonth(4)->toDateString();
        $account_log->save();
        ...
        $account_log->is_income = 0;
        $account_log->is_expense = 1;
        $account_log->date = Carbon::now()->subMonth(5)->toDateString();
        $account_log->save();
        ...
        $account_log->is_income = 0;
        $account_log->is_expense = 1;
        $account_log->date = Carbon::now()->subMonth(6)->toDateString();
        $account_log->save();
    }
}
