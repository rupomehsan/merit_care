                    ...
                    <div class="teacher box_shadow">
                        ...
                        <div class="teacher_discription">
                            ...
                            <div class="teacher_contact">
                                <ul>
                                    <li>
                                        <a href="mailto://{{ $item->mail_link }}"><i class="fa-regular fa-envelope"></i></a>
                                    </li>
                                    <li>
                                        <a href="{{ $item->linkedin_link }}" target="_blank"><i class="fa-brands fa-linkedin-in"></i></a>
                                    </li>
                                    <li>
                                        <a href="{{ $item->twitter_link }}" target="_blank"><i class="fa-brands fa-twitter"></i></a>
                                    </li>
                                    <li>
                                        <a href="{{ $item->facebook_link }}" target="_blank"><i class="fa-brands fa-facebook-f"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
