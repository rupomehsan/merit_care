                ...
                <table class="table table-bordered table_area mb-2 mt-1" v-if="show_routine == 1">
                    <thead>
                        <tr class="table_head_area">
                            ...
                            <th class="head_subject_title">Teacher</th>
                    ...
                    <tbody>
                        ...
                        <template v-for="(classItem, index) in custom_routine">
                            ...
                            <tr class="table_body" :key="index">
                                <td class="class" v-if="classItem.class_rowspan" :rowspan="classItem.class_rowspan">
                                    {{ classItem.class_name }}
                                </td>
                                <td class="batch" v-if="classItem.batch_rowspan" :rowspan="classItem.batch_rowspan">
                                    {{ classItem.batch_name_only }}
                                </td>
                                <td class="subject">{{ classItem.subject_name }}</td>
                                <td class="subject">{{ classItem.saturday_teacher }}</td>
                                <td class="class_time_and_room_content">
                                    <span class="class_time_and_room" v-if="classItem.saturday_time">
                                ...
                                <td class="class_time_and_room_content">
                                    <span class="class_time_and_room" v-if="classItem.sunday_time">
                                ...
                                <td class="class_time_and_room_content">
                                    <span class="class_time_and_room" v-if="classItem.monday_time">
                                ...
                                <td class="class_time_and_room_content">
                                    <span class="class_time_and_room" v-if="classItem.tuesday_time">
                                ...
                                <td class="class_time_and_room_content">
                                    <span class="class_time_and_room" v-if="classItem.wednesday_time">
                                ...
                                <td class="class_time_and_room_content">
                                    <span class="class_time_and_room" v-if="classItem.thursday_time">
                                ...
                                <td class="class_time_and_room_content">
                                    <span class="class_time_and_room" v-if="classItem.friday_time">
                ...
                <table class="table table-bordered table_area mb-2 mt-1" v-else>
                    ...
                    <tbody>
                        ...
                        <tr class="table_body" v-for="item in get_all_routines_by_date" :key="item.id">
                            <td>{{ item.day }}</td>
                            <td v-if="item.teacher">{{ item.teacher.user.first_name }} {{ item.teacher.user.last_name }}
                            </td>
