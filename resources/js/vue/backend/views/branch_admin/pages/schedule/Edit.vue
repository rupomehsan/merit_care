                        ...
                        <div class="col-lg-10">
                            <div class="admin_form form_1" v-if="this[`get_${store_prefix}`]">
                                ...
                                <div class=" form-group d-grid align-content-start gap-1 mb-2 " >
                                    ...
                                    <input type="time" class="form-control" name="start_time" :value="this[`get_${store_prefix}`]['start_time']">
                                </div>

                                <div class=" form-group d-grid align-content-start gap-1 mb-2 " >
                                    <label for="end_time">End Time</label>
                                    <input type="time" class="form-control" name="end_time" :value="this[`get_${store_prefix}`]['end_time']">
                                </div>
