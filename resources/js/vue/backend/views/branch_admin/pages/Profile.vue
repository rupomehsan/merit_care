                        ...
                        <form @submit.prevent="updateUser($event.target)">
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="first_name" :value="get_auth_information.first_name"
                                        class="form-control" id="basic-icon-default-fullname" placeholder="John Doe"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                            class="fa fa-user"></i></span>
                                    <input type="text" name="last_name" :value="get_auth_information.last_name"
                                        class="form-control" id="basic-icon-default-fullname" placeholder="John Doe"
                                        aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" />
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="email" :value="get_auth_information.email"
                                        id="basic-icon-default-email" class="form-control" placeholder="john.doe"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="mobile_number" :value="get_auth_information.mobile_number"
                            ...
                            <img :src="get_auth_information.photo" width="50" height="50" class="img-fluid mb-2">
                            <div class="mb-3">
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="file" name="photo"
                                        id="basic-icon-default-photo" class="form-control phone-mask" />
                                </div>
                            </div>
