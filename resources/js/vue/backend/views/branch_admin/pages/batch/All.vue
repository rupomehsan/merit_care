                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'fee'" :title="'Fee'" />
                                ...
                                <div class="table_actions">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <permission-button
                                                :permission="'can_create'"
                                                :to="{name:`Add${route_prefix}Subject`,params:{id:item.id}}"
                                                :classList="''">
                                                <i class="fa-solid text-primary fa-square-plus"></i>
                                                Manage Subject
                                            </permission-button>
                                        </li>
                                        <li>
                                            <permission-button
                                                :permission="'can_create'"
                                                :to="{name:`Add${route_prefix}Notification`,params:{id:item.id}}"
                                                :classList="''">
                                                <i class="fa-solid text-primary fa-bell"></i>
                                                Create Notification
                                            </permission-button>
                                        </li>
                                        <li>
                                            <permission-button
                                                :permission="'can_create'"
                                                :to="{name:`Add${route_prefix}Sms`,params:{id:item.id}}"
                                                :classList="''">
                                                <i class="fa-solid text-primary fa-envelope"></i>
                                                Create SMS
                                            </permission-button>
                                        </li>
                                        <li>
