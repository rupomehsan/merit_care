                            ...
                            <div class="admin_form form_1" v-if="this[`get_${store_prefix}`]">
                                <div class=" form-group d-grid align-content-start gap-1 mb-2 " >
                                    ...
                                    <input-field
                                        :label="`Monthly Fee`"
                                        :name="`fee`"
                                        :value="this[`get_${store_prefix}`]['fee']"
                                    />

                                    <label for="class_id">Class</label>
                                    <select id="defaultSelect" name="institute_class_id" class="form-select">
                                        <option v-for="(class_level, index) in get_class_levels.data"
                                            :key="index" :value="class_level.id">
                                            {{ class_level.title }}
                                        </option>
                                    </select>
                                </div>
