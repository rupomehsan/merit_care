        ...
        <div class="card list_card">
            ...
            <div class="table-responsive card-body text-nowrap">
                <table class="table table-hover table-striped table-bordered">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr v-for="item in get_all_orders.data" :key="item.id">
                            <td>
            ...
            <div class="card-footer py-1 border-top-0">
                <div class="d-inline-block">
                    <pagination :data="this[`get_all_orders`]" :limit="5" :size="'small'" :show-disabled="true" :align="'left'"
                ...
                <div class="show-limit d-inline-block">
                    <span>Total:</span>
                    <span>{{ this[`get_all_orders`].total }}</span>
                </div>
            </div>
        </div>
