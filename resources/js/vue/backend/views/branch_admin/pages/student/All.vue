                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'branch_code'" :title="'branch_code'" />
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td>{{ item.id }}</td>
                            <td>
                                <img :src="`/${item.user.photo}`" v-if="item.user" style="height: 40px;" alt="">
                            </td>
                            <td v-if="item.user">
                            ...
                            <td>
                                <ul class="list-group" v-for="(batch, index) in item.institute_class_batches" :key="index">
