            ...
            <div class="table-responsive card-body text-nowrap">
                <table class="table table-hover table-striped table-bordered">
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="(item, index) in get_single_student_attendence_by_id" :key="index">
...
export default {
    ...
    created: function () {
        ...
        this.fetch_single_student_attendence_by_id({id: this.$route.params.id});
    },
    methods: {
        ...mapActions([
            `fetch_single_student_attendence_by_id`,
        ]),
        ...mapMutations([
    ...
    computed: {
        ...mapGetters([
            `get_exam_students`,
            `get_single_student_attendence_by_id`
        ])
    }
};
</script>
