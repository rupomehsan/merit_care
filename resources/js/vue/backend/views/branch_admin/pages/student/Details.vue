            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="d-flex align-items-center mb-3"><i class="ti ti-check"></i><span class="fw-bold mx-2">Monthly fee:</span> <span>{{ this[`get_${store_prefix}`].student.monthly_fee }}</span></li>
