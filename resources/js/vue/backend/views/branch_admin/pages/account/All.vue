                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'account_no'" :title="'Account number'" />
                            <table-th :sort="true" :tkey="'account_mobile_no'" :title="'Account Mobile Number'" />
                            <table-th :sort="true" :tkey="'total_expense'" :title="'Total Expense'" />
                            <table-th :sort="true" :tkey="'total_income'" :title="'Total Income'" />
                            <table-th :sort="true" :tkey="'net_balance'" :title="'Net Balance'" />
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td><span v-if="item.account_details">{{ item.account_details.account_no }}</span></td>
                            <td><span v-if="item.account_details">{{ item.account_details.account_mobile_no }}</span></td>
