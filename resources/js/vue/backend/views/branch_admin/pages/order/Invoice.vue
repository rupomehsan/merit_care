        ...
        <div class="card list_card">
            ...
            <div class="card-body pb-5" v-if="this[`get_${store_prefix}`]" id="print_section">
                <section class="balance_sheet">
                    <div class="balance_sheet_content" v-if="get_auth_information.branch_admin">
                        ...
                        <div class="header_area_full" style="background-image: url(/test/bg1.png);">
                            <div class="container">
                                <div class="header_area">
                                    ...
                                    <div class="logo_area">
                                        <img :src="get_auth_information.branch_admin[0].branch_details.image" alt="logo">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            <div class="customar_name_address_and_invoice_id_date_area">
                                ...
                                <div class="customar_name_address_arer">
                                    ...
                                    <div class="customar_name_address" v-if="get_auth_information.branch_admin">
                                        <div class="customar_name">
                                            <h3 class="name_text">{{ get_auth_information.branch_admin[0].branch_details.coaching_name }}, {{ get_auth_information.branch_admin[0].branch_details.name }}</h3>
                                        </div>
                                        <div class="customar_address">
                                            <div class="address_text_area">
                                                <p class="address_text">{{ get_auth_information.branch_admin[0].branch_details.invoice_address }}</p>
