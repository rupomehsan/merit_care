        ...
        <div class="row">
            <div class="col-xl-12 mb-4 col-lg-12 col-12">
                ...
                <div v-if="notification_status" class="alert alert-primary alert-dismissible fade show" role="alert">
                    ...
                    <router-link :to="{ name: 'branch_notification' }" class="alert-link font-weight-bold"> View all
                    ...
                    <div class="mx-2 mb-3">
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <input type="date" class="form-control" name="from_date" v-model="from_date"
                                    id="from_date">
                            </div>
                            <div class="col-md-5">
                                <label for="month">To Date</label>
                                <input type="date" class="form-control" name="to_date" v-model="to_date" id="to_date">
                            </div>
                            <div class="col-md-2">
                                <div class="filter_btn mt-2">
                                    <button @click.prevent="filter_stats_by_month()"
...
export default {
    ...
    methods: {
        ...
        filter_stats_by_month: function () {
            let date = {
                from_date: this.from_date,
                to_date: this.to_date,
            }
            this.fetch_branch_dashboard_stats_by_month(date);
        }
    },
    computed: {
        ...mapGetters([
