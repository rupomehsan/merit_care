                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'exam_title'" :title="'Exam title'" />
                            <th aria-label="total_examinee">Total Examinee</th>
                            <!-- <th aria-label="absent_student">Absent Students</th> -->
                            <th aria-label="mark_given">Mark given</th>
                            <th aria-label="mark_not_given">Mark not given</th>
                            <table-th :sort="true" :tkey="'class'" :title="'Class'" />
                            <table-th :sort="true" :tkey="'batch'" :title="'Batch'" />
                            <table-th :sort="true" :tkey="'subject'" :title="'subject'" />
                            <table-th :sort="true" :tkey="'created_at'" :title="'Created at'" />
                            <th aria-label="result">Result</th>
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td class="text-info fw-bolder">{{ item.total_student }}</td>
                            <td class="text-success fw-bolder">{{ item.mark_given }}</td>
                            <td class="text-warning fw-bolder">{{ item.total_student - item.mark_given }}</td>
                            <td>
                                <span v-if="item.batch">
                                    {{ item.batch.class.title }}
                                </span>
                                <span v-else class="text-danger">No batch selected</span>
                            </td>
                            ...
                            <td>
                                ...
                                <span v-else class="text-danger">No subject selected</span>
                            </td>
                            ...
                            <td>
                                <button class="btn btn-sm btn-outline-primary">
                                    <permission-button
                                        :permission="'can_create'"
                                        :to="{name:`Assign${route_prefix}Result`,params:{id:item.id}}"
                                        :classList="''">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <permission-button
                                                :permission="'can_create'"
                                                :to="{}"
                                                :click="()=>call_store(`delete_${store_prefix}`,item.id)"
                                                :click_param="item.id"
                                                :classList="''">
