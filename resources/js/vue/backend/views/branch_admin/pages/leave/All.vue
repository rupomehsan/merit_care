                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'user_id'" :title="'Name'" />
                            <table-th :sort="true" :tkey="'from_date'" :title="'From'" />
                            <table-th :sort="true" :tkey="'to_date'" :title="'To'" />
                            <table-th :sort="true" :tkey="'duration'" :title="'Duration'" />
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td>
                                <span v-if="item.status == 'accepted'" class="badge bg-success">{{ item.status }}</span>
