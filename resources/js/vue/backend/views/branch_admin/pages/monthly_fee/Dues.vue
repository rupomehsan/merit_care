    ...
    <div class="conatiner">
        ...
        <div class="card list_card">
            <div class="card-header">
                ...
                <div class="search">
                    <form action="#" class="d-flex align-items-center gap-1" @submit.prevent="()=>''">
                        <input
                            @keyup="set_monthly_fees_search_key($event.target.value)"
                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="false" :tkey="'amount'" :title="'Total Bill'" />
                            <table-th :sort="false" :tkey="'amount'" :title="'Paid'" />
                            <table-th :sort="false" :tkey="'amount'" :title="'Due'" />
                            <table-th :sort="false" :tkey="'amount'" :title="'Advance'" />
                            <th aria-label="actions">Actions</th>
                        </tr>
                    </thead>
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_monthly_dues`].data" :key="item.id">
                            <td>
                            ...
                            <td>
                                <span v-if="item.user" class="text-warning cursor_pointer" @click.prevent="call_store(`set_${store_prefix}`,item)">
            ...
            <div class="card-footer py-1 border-top-0">
                <div class="d-inline-block">
                    <pagination :data="this[`get_monthly_dues`]" :limit="5" :size="'small'" :show-disabled="true" :align="'left'"
                ...
                <div class="show-limit d-inline-block">
                    <span>Limit:</span>
                    <select @change.prevent="fetch_dues_by_month({page: $event.target.value,})">
                ...
                <div class="show-limit d-inline-block">
                    <span>Total:</span>
                    <span>{{ this[`get_monthly_dues`].total }}</span>
                </div>
            </div>
        </div>
...
export default {
    ...
    created: function(){
        ...
        this.fetch_dues_by_month({page: 1});
    },
    methods: {
        ...mapActions([
        ...
        handle_pagination: function(page=1){
            return this[`fetch_dues_by_month`]({page});
        },
