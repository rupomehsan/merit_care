                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'name'" :title="'Customer Name'" />
                            <table-th :sort="true" :tkey="'topic'" :title="'Topic'" />
                            <table-th :sort="true" :tkey="'feedback'" :title="'Feedback'" />
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td v-if="item.topic">
                                <span class="text-info">{{ item.topic.title }}</span>
                            </td>
                            <td v-else>Not found</td>
                            <td>
                                {{ item.feedback }}
