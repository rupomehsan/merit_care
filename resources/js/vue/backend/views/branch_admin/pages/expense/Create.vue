<template>
    <div class="container">
        <div class="card list_card">
            ...
            <form @submit.prevent="call_store(`store_${store_prefix}`,$event.target)" autocomplete="false" class="expense_create_form" enctype="multipart/form-data">
                <div class="card-body">
                            ...
                            <div class="admin_form form_1">
                                ...
                                <!-- <div class=" form-group d-grid align-content-start gap-1 mb-2 ">
                                    ...
                                    <select class="form-select" name="category" id="category">
                                        <option v-for="item in get_all_account_categories" :key="item.id" :value="item.id">{{ item.title }}</option>
                                    </select>
                                </div> -->
                                ...
                                <div class=" form-group d-grid align-content-start gap-1 mb-2">
                                    ...
                                    <select name="account_id" class="form-select" id="">
                                        <option v-for="ac in accounts" :value="ac.id" :key="ac.id">
                                            {{ ac.title }}
                                        </option>
                                    </select>
                                </div>
...
export default {
    ...
    created: function () {
        ...
        axios.get('/account/admin-accounts/all-json')
            .then(res=>{
