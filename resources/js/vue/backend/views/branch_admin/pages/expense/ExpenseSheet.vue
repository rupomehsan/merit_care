            ...
            <div class="table-responsive card-body text-nowrap">
                <div class="row">
                    <div class="col-md-6 mb-2">
                        ...
                        <select v-model="month" @change="filter_expense_by_month($event)" class="form-select" name="month" id="month">
                ...
                <table class="table table-hover table-striped table-bordered">
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in get_expenses.data" :key="item.id">
                            <td>
                        ...
                        <tr>
                            ...
                            <td>{{ this[`get_${store_prefix}s`].total_monthly_expense ? this[`get_${store_prefix}s`].total_monthly_expense : subTotal }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
export default {
    ...
    methods: {
        ...
        filter_expense_by_month: function(event) {
            this.fetch_expense_by_month(event);
        },
    ...
    computed: {
        ...
        subTotal: function() {
            var total_amount = 0;
            if(this.get_expenses.data.length > 0) {
                this.get_expenses.data.forEach(element => {
