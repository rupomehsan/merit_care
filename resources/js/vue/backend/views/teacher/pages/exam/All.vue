        ...
        <div class="card list_card">
            ...
            <div class="table-responsive card-body text-nowrap">
                <table class="table table-hover table-striped table-bordered">
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in get_exam_of_teacher.data" :key="item.id">
                            <td>
                            ...
                            <td>
                                ...
                                <router-link :to="{name:`ExamResult`,params:{id:item.id}}">
            ...
            <div class="card-footer py-1 border-top-0">
                <div class="d-inline-block">
                    <pagination :data="get_exam_of_teacher" :limit="5" :size="'small'" :show-disabled="true" :align="'left'"
                ...
                <div class="show-limit d-inline-block">
                    <span>Total:</span>
                    <span>{{ get_exam_of_teacher.total }}</span>
                </div>
            </div>
        </div>
...
export default {
    ...
    created: function(){
        this.fetch_exam_of_teacher();
    },
    methods: {
        ...mapActions([
            `fetch_exam_of_teacher`,
