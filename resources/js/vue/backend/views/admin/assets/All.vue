            ...
            <div class="table-responsive card-body text-nowrap">
                <div class="row">
                    <div class="col-6">
                        ...
                        <select name="branch_id" class="form-select mb-3" v-model="branch_id" @change="call_assets_by_branch($event)" id="branch_id">
                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'buying_date'" :title="'buying date'" />
                            <table-th :sort="true" :tkey="'price'" :title="'Purchase price'" />
                            <table-th :sort="true" :tkey="'depreciation_price'" :title="'Depreciation price'" />
