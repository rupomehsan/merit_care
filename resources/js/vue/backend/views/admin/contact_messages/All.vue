                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'seen'" :title="'Seen'" />
                            <table-th :sort="true" :tkey="'status'" :title="'Status'" />
                            <th aria-label="actions">Actions</th>
                        </tr>
                    </thead>
                    <tbody class="table-border-bottom-0 table-hover table-striped">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td>
                                <span class="text-info">
                                    {{ truncatedMessage(item.message) }}
                                </span>
                            </td>
                            <td>
                                <span v-if="item.seen == 1" class="badge bg-label-success me-1">Seen</span>
                                <span v-if="item.seen == 0" class="badge bg-label-danger me-1">Not Seen</span>
                            </td>
                            <td>
                                <span v-if="item.status == 1" class="badge bg-label-success me-1">active</span>
                                <span v-if="item.status == 0" class="badge bg-label-danger me-1">deactive</span>
                            </td>
                            <td>
                                <div class="table_actions">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="" @click.prevent="markAsSeen(item.id, item.seen)">
                                                <i class="fa text-info fa-eye"></i>
                                                Mark as seen/Unseen
                                            </a>
                                        </li>
