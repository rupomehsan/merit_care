                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'price'" :title="'price'" />
                            <table-th :sort="false" :tkey="'stock'" :title="'stock'" />
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td>{{ item.price }}</td>
                            <td>{{ purchase_stock(item.purchase_stock_sum_qty) - sell_stock(item.sell_stock_sum_qty) }}</td>
                            <td>
                                <div class="table_actions">
                                    ...
                                    <ul>
                                        <li>
                                            <permission-button
                                                :permission="'can_edit'"
                                                :to="{name:`Stock${route_prefix}`,params:{id:item.id}}"
                                                :classList="''">
                                                <i class="fa-solid text-primary fa-boxes-stacked"></i>
                                                Manage Stock
                                            </permission-button>
                                        </li>
                                        <li>
...
export default {
    ...
    methods: {
        ...
        purchase_stock: function(amount) {
