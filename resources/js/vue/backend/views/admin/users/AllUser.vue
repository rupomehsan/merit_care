            ...
            <div class="table-responsive card-body text-nowrap">
                <div class="row">
                    <div class="col-6">
                        ...
                        <select name="branch_id" class="form-select mb-3" v-model="branch_id" @change="call_users_by_branch($event)" id="branch_id">
                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <user-table-th :sort="false" :tkey="`branch`" :title="`Branch`" />
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td >
                                <span class="text-primary" v-if="item.branch_user.length > 0">
                                    {{ item.branch_user[0].name }}
                                </span>
                            </td>
                            <td>{{ item.email }}</td>
                            <td>
