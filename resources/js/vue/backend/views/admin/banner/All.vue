                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'banner'" :title="'Banner'" />
                            <table-th :sort="true" :tkey="'title_highlight'" :title="'Highlighted title'" />
                            <table-th :sort="true" :tkey="'paragraph'" :title="'paragraph'" />
                            <table-th :sort="true" :tkey="'link'" :title="'link'" />
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td v-if="item.image"><img :src="item.image" class="img-fluid" width="200" alt=""></td>
                            <td v-else>
                                No Image found
                            </td>
                            <td>{{ item.title_highlight }}</td>
                            <td><span class="d-inline-block text-truncate" style="max-width: 250px;">{{ item.paragraph }}</span></td>
                            <td>{{ item.link }}</td>
                            <td>
                                <div class="table_actions">
