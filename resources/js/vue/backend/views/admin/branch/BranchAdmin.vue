                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="false" :tkey="'admin'" :title="'Admin'" />
                            <table-th :sort="false" :title="'Admin Email'" />
                            <table-th :sort="true" :tkey="'street'" :title="'Address'" />
                        ...
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td>
                                ...
                                <span class="fw-semibold">
                                    <ul class="list-group" v-if="item.branch_admin">
                                        <li v-for="(admin, key) in item.branch_admin" :key="key">
                            ...
                            <td>
                                <router-link class="btn btn-sm btn-outline-primary waves-effect text-primary" :to="{name:`Create${route_prefix}Admin`, params:{id:item.id}}">
                                    <i class="fa fa-plus me-5px"></i>
                                    Add Branch Admin
                                </router-link>
                                <!-- <router-link class="btn btn-sm btn-outline-warning waves-effect text-warning" :to="{name:`EditUser`, params:{id:item.id}}">
                                    <i class="fa fa-pencil me-5px"></i>
                                    Edit
                                </router-link> -->
                            </td>
...
export default {
    ...
    watch : {
        get_branchs: function(val) {
            console.log(val.data);
            if(val.data.branch_admin>0) {
                this.branch_admins = val.data.branch_admin
            }
        }, 
    },
    methods: {
