                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'coaching_name'" :title="'Coaching Name'" />
                            <table-th :sort="true" :tkey="'name'" :title="'Branch Name'" />
                            <table-th :sort="true" :tkey="'branch_code'" :title="'Branch Code'" />
                            <table-th :sort="true" :tkey="'street'" :title="'Street'" />
                            <table-th :sort="true" :tkey="'city'" :title="'City'" />
                            <table-th :sort="true" :tkey="'state'" :title="'State'" />
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td>{{ item.id }}</td>
                            <td>
                                <span class="text-primary cursor_pointer" @click.prevent="call_store(`set_${store_prefix}`,item)">
                                    {{ item.coaching_name }}
                                </span>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="table_actions">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <permission-button v-if="item.is_central != 1"
