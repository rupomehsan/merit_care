            ...
            <div class="table-responsive card-body text-nowrap">
                <div class="row">
                    <div class="col-6">
                        ...
                        <select name="branch_id" class="form-select mb-3" v-model="branch_id" @change="call_monthlyfee_by_branch($event)" id="branch_id">
                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'user_id'" :title="'Student'" />
                            <table-th :sort="true" :tkey="'amount'" :title="'Total Amount'" />
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td>{{ item.id }}</td>
                            <td><span class="text-primary" v-if="item.branch">{{ item.branch.name }}</span></td>
                            <td>
                            ...
                            <td>{{ item.amount }}</td>
                            <td>{{ item.account_log.account.title }}</td>
                            <td>{{ item.date }}</td>
                            <td>
                                <div class="table_actions">
...
export default {
    ...
    methods: {
        ...
        call_monthlyfee_by_branch: function(event) {
