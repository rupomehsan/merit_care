            ...
            <div class="table-responsive card-body text-nowrap">
                <div class="row">
                    <div class="col-6">
                        ...
                        <select name="branch_id" class="form-select mb-3" v-model="branch_id" @change="call_customer_by_branch($event)" id="branch_id">
...
export default {
    ...
    methods: {
        ...
        call_customer_by_branch: function(event) {
