            ...
            <div class="table-responsive card-body text-nowrap">
                <div class="row">
                    <div class="col-6">
                        ...
                        <select name="branch_id" class="form-select mb-3" v-model="branch_id" @change="call_exam_by_branch($event)" id="branch_id">
                ...
                <table class="table table-hover table-striped table-bordered">
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td>
                                <span class="text-primary" v-if="item.branch">
                                    {{ item.branch.name }}
                                </span>
                            </td>
...
export default {
    ...
    methods: {
        ...
        call_exam_by_branch: function(event) {
