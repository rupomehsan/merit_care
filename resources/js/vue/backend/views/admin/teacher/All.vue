            ...
            <div class="table-responsive card-body text-nowrap">
                <div class="row">
                    <div class="col-6">
                        ...
                        <select name="branch_id" class="form-select mb-3" v-model="branch_id" @change="call_teacher_by_branch($event)" id="branch_id">
                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="false" :tkey="'branch_id'" :title="'Branch'" :ariaLable="'Branch'"/>
                            <table-th :sort="false" :tkey="'name'" :title="'Name'" />
                            <table-th :sort="false" :tkey="'email'" :title="'Email'" />
                            <table-th :sort="false" :tkey="'phone'" :title="'Phone'" />
                            <table-th :sort="false" :tkey="'created_at'" :title="'Created at'" />
                            <table-th :sort="false" :tkey="'status'" :title="'Status'" />
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td>{{ item.id }}</td>
                            <td v-if="item.user"><span class="text-primary" v-if="item.user.branch_user">{{ item.user.branch_user[0].name }}</span></td>
...
export default {
    ...
    methods: {
        ...
        call_teacher_by_branch: function(event) {
