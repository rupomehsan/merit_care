            ...
            <div class="table-responsive card-body text-nowrap">
                <div class="row">
                    <div class="col-6">
                        ...
                        <select name="branch_id" class="form-select mb-3" v-model="branch_id" @change="filter_attendence_by_branch($event)" id="branch_id">
                    ...
                    <div class="col-6">
                        ...
                        <select name="role_id" class="form-select mb-3" @change="filter_attendence_by_role($event)" id="role_id">
                ...
                <table class="table table-hover table-striped table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'branch_id'" :title="'Branch'"/>
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td>{{ item.id }}</td>
                            <td>
                                <span v-if="item.branch.coaching_name">
                                    {{ item.branch.coaching_name }}
                                </span> 
                                <span v-if="item.branch.name">
                                    , {{ item.branch.name }}
                                </span>
                            </td>
                            <td>
...
export default {
    ...
    methods: {
        ...
        filter_attendence_by_branch: function(event) {
        ...
        filter_attendence_by_role: function(event) {
            // console.log(event.target.value);
