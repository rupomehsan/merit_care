        ...
        <div class="card list_card">
            <div class="card-header">
                ...
                <div class=" form-group d-grid align-content-start gap-1 mb-2" style="padding-right: 50px;">
                    ...
                    <input class="form-control" @change.prevent="get_attendence_employee()" type="date" v-model="attendence_date">
                </div>
            ...
            <div v-if="this[`get_admin_employee_attendences`] && this[`get_admin_employee_attendences`].length > 0" class="table-responsive card-body text-nowrap mb-5">
                <table class="table table-hover table-striped table-bordered">
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="(item, index) in this[`get_admin_employee_attendences`]" :key="item.id">
                            ...
                            <td>
                                ...
                                <span v-else>
                                    <input class="form-control" type="time" @change.prevent="add_start_time(item, $event)">
                                </span>
                            </td>
                            ...
                            <td>
                                ...
                                <span v-else>
                                    <input class="form-control" type="time" @change.prevent="add_end_time(item, $event)">
                                </span>
                            </td>
...
export default {
    ...
    methods: {
        ...mapActions([
            ...
            `admin_employee_attendence_submit`,
            `admin_employee_attendence_update`
        ]),
        ...mapMutations([
            ...
            `set_admin_employee_attendences`
        ]),
        ...
        add_end_time: function(employee, event) {
            ...
            this.admin_employee_attendence_update(data)
            this[`fetch_admin_${store_prefix}s`](this.attendence_date);
        ...
        ResetAttendence: async function(employee) {
            ...
            if(confirm) {
                if(this.attendence_date == null) {
                    ...
                    this.admin_employee_attendence_submit(data)
    ...
    computed: {
        ...mapGetters([
            `get_${store_prefix}s`,
            `get_admin_employee_attendences`,
            `get_${store_prefix}_selected`,
            `get_admin_employee_attendence_show_active_data`
        ]),
    }
}
</script>
