...
const actions = {
    ...
    fetch_teacher_routine_by_id: async function ({
        state,
        commit
    }, {
        id
    ...
    [`fetch_${store_prefix}`]: async function ({
        state,
        commit
    }, {
        id
    ...
    [`store_${store_prefix}`]: function ({
        ...
        const {
            ...
            form_inputs,
            form_data
        } = window.get_form_data(`.schedule_create_form`);
        ...
        axios.post(`/${api_prefix}/store`, form_data)
            .then(res => {
                ...
                if (res.data.type == 'warning') {
                    ...
                    management_router.push({
                        name: `AllBranch${route_prefix}`
                    })
                }
            })
            .catch(error => {
    ...
    [`update_${store_prefix}`]: function ({
        ...
        const {
            ...
            form_inputs,
            form_data
        } = window.get_form_data('.schedule_edit_form');
        const {
            get_class_level_selected: classlevel,
            get_teacher_selected: teacher,
