...
const api_prefix = `contact-message`;
...
const actions = {
    ...
    update_message_status: async function({ state, getters, dispatch }, data) {
        
        axios.post(`/${api_prefix}/update-status`, {data})
            .then((res) => {
    ...
    update_message_status_auto: async function({ state, getters, dispatch }, data) {
